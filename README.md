...
#### Бэкенд #
- [ ] Исправить Socket.IO интеграционные тесты (сейчас 36 тестов падают из 61)
- [ ] Повысить покрытие кода до 80%+ (текущий ~26% lines)
- [ ] Стабилизировать middleware аутентификации для Socket.IO
- [ ] Развернуть TURN сервер для WebRTC в продакшене
- [ ] Расширить unit тесты моделей с покрытием edge cases

#### Фронтенд #
- [ ] Исправить WindowsSocket тесты с таймаутами
- [ ] Создать e2e тесты для основных пользовательских потоков с Cypress
...
**Тестирование:**
- [ ] Socket.IO тесты: 100% успех (сейчас ~41%)
- [ ] Покрытие кода: 80%+ (сейчас ~26%)
- [ ] E2E тесты: Полная автоматизация основных потоков

**Производительность:**
- [ ] Время отклика <100ms для всех операций
- [ ] WebRTC: Качественный звук с TURN сервером

**Продакшен готовность:**
- [ ] TURN сервер: Развернут и протестирован
