...
- Комплексные улучшения и исправления системы Chat-JS (caa9a72)
- Massive expansion of unit tests with extensive edge case coverage (d297667)
- Комплексные улучшения и исправления для проекта Chat-JS - включение автоматической документации (f206c39)
- Comprehensive critical improvements and bug fixes for Chat-JS (790cebb)
- Commitment всех изменений в проекте Chat-JS (d623212)
...
- Update changelog and test reports, fix: minor server and socket test corrections (bd8b4a9)
...
- Fix additional ESLint warnings in backend: unused vars in src, tests (0c1e515)
- Изменения в архитектуре (59cb699)
- fix DOC (7d905bd)
